...
function add_theme_scripts() {
  ...
  wp_enqueue_style( 'ronin', get_template_directory_uri() . '/css/ronin.min.css', array('bootstrap') );
  ...
  wp_enqueue_script( 'ronin', get_template_directory_uri() . '/js/ronin.min.js', array( 'jquery' ) );
}
